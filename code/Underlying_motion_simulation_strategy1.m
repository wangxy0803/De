...
count_step1 = 1;
phi_step1 = phi_initial;
R_step1 = [cos(phi_step1/180*pi), -sin(phi_step1/180*pi);sin(phi_step1/180*pi), cos(phi_step1/180*pi)];
[p_step1_x, p_step1_y] = get_p_step1(R_target, p_target, b22, R_step1, p_initial);
...
TRUE_OR_FALSE = check_limitation(distance,R_step1*b22'+p_step1, a1(2),d_1y_step1,leg_1,width);
if TRUE_OR_FALSE
...
% TRUE_OR_FALSE = check_limitation(distance,R_step2*b22'+p_step2, a1(2),d_1y_step2,leg_1,width);
% if TRUE_OR_FALSE
...
% %     % draw the figure immediately
% %     draw_base_3bar(a_coordinate_source,p_cal,R_cal,b1,b2,b3,b4,b5,b6,length,width,rectangular_W,phi_cal,'change_color','k');
% %     draw_move_3bar(d_1x,d_2x,d_3x,d_1y,d_2y,d_3y,width,a1,a2,a3,r,rectangular_L,rectangular_W,b11,b22,b33,R_cal,p_cal,'change_color','k');
% 
% end
% 
% 
...
% % get target configuration and d of step2
% count_step3= 1;
% phi_step3 = phi_target;
% R_step3 = [cos(phi_step3/180*pi), -sin(phi_step3/180*pi);sin(phi_step3/180*pi), cos(phi_step3/180*pi)];
% p_step3 = p_target;
% 
% 
% disp('get step2 target d:');
% [d_1x_step3, d_1y_1_step3, d_1y_2_step3, c_1x_step3, c_1y_1_step3, c_1y_2_step3] = calcaulate_d_3bar(p_step3, phi_step3/180*pi, b11, a1, 1/2*length, INVALID_VALUE, rectangular_L, leg_1);
% disp('calcaulate_d of joint_1 end!');
% [d_2x_step3, d_2y_1_step3, d_2y_2_step3, c_2x_step3, c_2y_1_step3, c_2y_2_step3] = calcaulate_d_3bar(p_step3, phi_step3/180*pi, b22, a2, 1/2*length, INVALID_VALUE, rectangular_L, leg_2);
% disp('calcaulate_d of joint_2 end!');
% [d_3x_step3, d_3y_1_step3, d_3y_2_step3, c_3x_step3, c_3y_1_step3, c_3y_2_step3] = calcaulate_d_3bar(p_step3, phi_step3/180*pi, b22, a3, 1/2*length, INVALID_VALUE, rectangular_L, leg_3);
% disp('calcaulate_d of joint_3 end!');
% 
% [d_1y_step3,d_2y_step3,d_3y_step3] = select_d(d_1y_1_step3, d_1y_2_step3, d_2y_1_step3, d_2y_2_step3, d_3y_1_step3, d_3y_2_step3, INVALID_VALUE, a2, a3, rectangular_L, 'configuration_1', 'up');
% TRUE_OR_FALSE = check_limitation(distance,R_step3*b22'+p_step3, a1(2),d_1y_step3,leg_1,width);
% if TRUE_OR_FALSE
%     draw_base_3bar(a_coordinate_source,p_step3,R_step3,b1,b2,b3,b4,b5,b6,length,width,rectangular_W,phi_step3,'change_color','r');
%     draw_move_3bar(d_1x_step3,d_2x_step3,d_3x_step3,d_1y_step3,d_2y_step3,d_3y_step3,width,a1,a2,a3,r,rectangular_L,rectangular_W,b11,b22,R_step3,p_step3,'change_color','r');
% else
%     error('slider1 is out of the limitation!');
% end
% 
% % move vertically
% flag_step3 = 0;
% sampling_time_step3 = 1;
% velocity_ratio_2_1_step3  = abs(d_2y - d_2y_step3)/abs(d_1y - d_1y_step3);
% velocity_ratio_3_1_step3  = abs(d_3y - d_3y_step3)/abs(d_1y - d_1y_step3);
% velocity_1_step3 = 10;
% velocity_2_step3 = velocity_ratio_2_1_step3*velocity_1_step3;
% velocity_3_step3 = velocity_ratio_3_1_step3*velocity_1_step3;
% 
% while 1 
%     if flag_step3 == 1
%         break;
%     end
% 
%     count_step3 = int64(count_step3) + 1;
% 
%     if d_1y > d_1y_step3 
%         if d_1y - sampling_time_step3*velocity_1_step3 > d_1y_step3
%             d_1y = d_1y - sampling_time_step3*velocity_1_step3;
%         else
%             d_1y = d_1y_step3;
%             flag_step3 = 1;
%         end
...
% 
%      if d_2y > d_2y_step3 
%         if d_2y - sampling_time_step3*velocity_2_step3 > d_2y_step3
%             d_2y = d_2y - sampling_time_step3*velocity_2_step3;
%         else
%             d_2y = d_2y_step3;
%             flag_step3 = 1;
%         end
...
% 
%     if d_3y > d_3y_step3
%         if d_3y - sampling_time_step3*velocity_3_step3 > d_3y_step3
%             d_3y = d_3y - sampling_time_step3*velocity_3_step3;
%         else
%             d_3y = d_3y_step3;
%             flag_step3 = 1;
%         end
...
%     p_cal_1 = [vpa(sol.p_x(num)),vpa(sol.p_y(num))]';
%     phi_cal_1 = double(vpa(2*atan(sol.t(num))/pi*180));
%     p_distance_1 = sqrt((p_cal_1(1)-p_all(1,count_step3-1))^2 + (p_cal_1(2)-p_all(2,count_step3-1))^2);
%     phi_distance_1 = abs(phi_cal_1 - phi_all(count_step3-1));
%     distance_1 = p_distance_1 + phi_distance_1;
% 
%     num = num_second;
%     p_cal_2 = [vpa(sol.p_x(num)),vpa(sol.p_y(num))]';
%     phi_cal_2 = double(vpa(2*atan(sol.t(num))/pi*180));
%     p_distance_2 = sqrt((p_cal_2(1)-p_all(1,count_step3-1))^2 + (p_cal_2(2)-p_all(2,count_step3-1))^2);
%     phi_distance_2 = abs(phi_cal_2 - phi_all(count_step3-1));
%     distance_2 = p_distance_2 + phi_distance_2;
% 
%     if distance_1 < distance_2
%         num = num_first;
